/**
 * NOTE: There is no equivalent program for this example in Microsoft Windows.  The
 * winAPI does not have a function for raising a signal in another process.  You can
 * raise a signal in the calling process, but not another.
 */
