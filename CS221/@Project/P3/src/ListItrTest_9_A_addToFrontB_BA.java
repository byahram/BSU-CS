 ...
 * ListIterator Tests for Change Scenario 9: [A] -> addToFront(B) -> [B, A]
 * 
 * @author Matt T 
 */
public class ListItrTest_9_A_addToFrontB_BA
{
	...
	{
		// create empty list 
		list = (IndexedUnsortedList<Integer>)TestCase.newList(listType);
