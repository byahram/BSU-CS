...
class PopQuizViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout
{
    ...
    override func viewDidLoad()
    {
        ...
        myCollectionView.register(QuestionsViewCell.self, forCellWithReuseIdentifier: "Cell")
        ...
        let que1 = Question(imgName: "seoul1", questionText: "What is the capital of South Korea ?", options: ["Busan", "Boise", "Seoul", "Osaka"], correctAns: 2, wrongAns: -1, isAnswered: false)
        let que2 = Question(imgName: "seoul2", questionText: "How manys subway lines in Seoul ?", options: ["11", "23", "22", "15"], correctAns: 2, wrongAns: -1, isAnswered: false)
        let que3 = Question(imgName: "seoul1", questionText: "What is the capital of South Korea ?", options: ["Busan", "Boise", "Seoul", "Osaka"], correctAns: 2, wrongAns: -1, isAnswered: false)
        let que4 = Question(imgName: "seoul2", questionText: "How manys subway lines in Seoul ?", options: ["11", "23", "22", "15"], correctAns: 2, wrongAns: -1, isAnswered: false)
        let que5 = Question(imgName: "seoul1", questionText: "What is the capital of South Korea ?", options: ["Busan", "Boise", "Seoul", "Osaka"], correctAns: 2, wrongAns: -1, isAnswered: false)
    ...
    {
        let cell=collectionView.dequeueReusableCell(withReuseIdentifier: "Cell", for: indexPath) as! QuestionsViewCell
    ...
    @objc func btnPrevNextAction(sender: UIButton)
    {
        if sender == btnNext && currentQuestionNumber == questionsArray.count {
            //            let v=ResultsViewController()
            //            v.score = score
            //            v.totalScore = questionsArray.count
            //            self.navigationController?.pushViewController(v, animated: true)
            //            return
            
            let alert = UIAlertController(title: "I couldnt access ResultViewController. That is all my final app!!", message: nil, preferredStyle: .alert)
...
extension PopQuizViewController: QuizCVCellDelegate
{
